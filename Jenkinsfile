...
pipeline {
    ...
    post {
        always {
            sh '/Users/jiuwang/Documents/oci-stream-jenkins/env/bin/python /Users/jiuwang/Documents/oci-stream-jenkins/jenkins_log_streaming.py --key build-log --msg $(/usr/local/bin/wget ${BUILD_URL}/consoleText)'
        }
